<p align="center">
  ...
  <h1 align="center">MAGOON FOR REACT DEVELOPER TOOLS</h1>
  <p align="center">A clean, and comforting React DevTools theme.</p>
  <p align="center">
...
<p align="center">
  A theme that makes colors go pop, and makes components look chromatically amazing! <br><br>
...
This is a theme created for the Chrome Extension [React Developer Tools](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi?hl=en). You install it by doing the following:

▶ Enter the extensions settings (It's a little cogwheel)  
▶ Click the Pen Icon  
▶ Get the content of theme.json, or go to [**this link**](https://goo.gl/Gds7zy) and copy the json  
▶ Paste the content you just copied into the input bar which says "Import/export"  
▶ You can now choose the Theme in the dropdown menu

<p align="center"><br>
  <h3 align="center">Does it look good enough to use?</h3>
  <p align="center">What can I say, it looks Magooney!</p>
  <img alt='example' src='https://user-images.githubusercontent.com/14088342/28041321-43170ef2-65c9-11e7-8c85-d62876c043c2.png' />
</p>

<p align="center">
  The theme was built with caffeine as a substance. Heh.<br><br>
