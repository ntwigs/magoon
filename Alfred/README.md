<p align="center">
  ...
  <p align="center">A clean, and comforting Alfred theme.</p>
  <p align="center">
...
This is a theme created for the application launcher and multi-tool for macOS Alfred. You can start using it by doing the following:

▶ Simply download it here [Packal.org](http://www.packal.org/theme/magoon).

▶ Alfred should now look miraculously good!

<p align="center"><br>
  <h3 align="center">Is it as wonderful as a heckin pupper?</h3>
  <p align="center">I wouldn't say that, but it looks like Magoon!</p>
  <img alt='example' src='https://i.imgur.com/nFoetN8.jpg' />
</p>
